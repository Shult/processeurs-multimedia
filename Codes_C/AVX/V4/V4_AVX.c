...
int main(int argc, char **argv) {
    ...
    __m256i AVXPixelIn = _mm256_set1_epi16(0.0);
    __m256i AVXPixelMin = _mm256_set1_epi16(0.0);
    __m256i AVXEtalement = _mm256_set1_epi16(0.0);
	__m256i AVXPixelOut = _mm256_set1_epi16(0.0);
	// =================================
...
InitClock;
	...
	AVXEtalement = _mm256_set1_epi16((short) ETALEMENT);
	AVXPixelMin = _mm256_set1_epi16((short) - LE_MIN);	// On met 8 fois la valeur 
...
ClockStart;
	...
	for (i = 0 ; i < TailleImage ; i = i + 8) {
		memcpy(&AVXPixelIn, &image[i], sizeof(AVXPixelIn));

		AVXPixelOut = _mm256_adds_epi16(AVXPixelIn, AVXPixelMin);
		AVXPixelOut = _mm256_mullo_epi16(AVXPixelOut, AVXEtalement);

		memcpy(&resultat[i], &AVXPixelOut, sizeof(AVXPixelOut));
	}
	// =================================
